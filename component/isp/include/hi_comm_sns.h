...
{	
	/*noise reduction calibration para 降噪校准*/
	ISP_NR_CABLI_PARA_S     stNrCaliPara;	// 2DNR校正相关的参数，由校正工具计算得到
	/*noise reduction iso para*/
	ISP_NR_ISO_PARA_TABLE_S stIsoParaTable[HI_ISP_NR_ISO_LEVEL_MAX];	// 2NDR与ISO联动的参数
...
{
	/*For Demosaic*/
	HI_BOOL bEnable;		// 该模块是否使能，0表示不使能，1表示使能；			
